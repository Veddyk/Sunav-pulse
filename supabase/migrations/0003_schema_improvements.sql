...
create index idx_call_reports_visit_date
...
create index idx_call_reports_rep_date
...
create index idx_gps_audit_created_at
...
create index idx_gps_audit_rep_created
...
create index idx_targets_product_period
  on targets (product_id, period_month desc);

create index idx_targets_product_period_rep
